...
function ItemDetail( {product} ) {
  ...
  return (
    <div className='container-detail'>
      ...
      <div className='d-det'>
        <h2><span className='gray-detls'>Producto:</span> {product.title}</h2>
        <h3><span className='gray-detls'>Valor: </span>$ {product.price} USD</h3>
        <p><span className='gray-detls-p'>Conocela un poco mas ...</span> {product.description}</p>
